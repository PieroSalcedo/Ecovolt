...
public interface UserRepository extends JpaRepository<User, Long> {
     ...
     */
    @Query("select o from Option o, RoleHasOption ro, Role r, UsuarioHasRol ur " +
            "where o.idOption = ro.id.idOption " +
            "and ro.id.idRol = r.idRol " +
            "and r.idRol = ur.usuarioHasRolPk.idRol " +
            "and ur.usuarioHasRolPk.idUser = ?1 " +
            "and o.estado = 1")
     ...
     */
    @Query("select r from Role r, UsuarioHasRol ur " +
            "where r.idRol = ur.usuarioHasRolPk.idRol " +
            "and ur.usuarioHasRolPk.idUser = ?1 " +
            "and r.estado = 1")
